...
function twentytwelve_setup() {
	...
	class My_Walker extends Walker_Nav_Menu
	{
		function start_el(&$output, $item, $depth, $args) {
			...
			$item_output .= '<span class="sup">' . $item->description . '</span>';
			$item_output .= '<span class="sub">' . $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after . '</span>';			
			$item_output .= '</a>';
...
function omb_comment( $comment, $args, $depth ) {
	$GLOBALS['comment'] = $comment;
	...
	<li <?php comment_class(); ?> id="li-comment-<?php echo $comment_id; ?>">
		<div id="div-comment-<?php echo $comment_id; ?>" class="comment-body">
			<div class="comment-author vcard">
				...
				?>
				<cite class="fn"><?php comment_author( $comment_id ); ?></cite>				
			</div><!-- .comment-meta -->
			...
			<p class="comment-content comment">
				<?php comment_text(); ?>
			</p><!-- .comment-content -->
			<div class="reply">
