	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use twentytwelve_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define twentytwelve_comment() and that will be used instead.
				 * See twentytwelve_comment() in twentytwelve/functions.php for more.
				 */
